    ...
    return (
        <div className="cake-container">
            <div className="container">
                ...
                <svg id="cake" width="200px" height="500px" viewBox="0 0 200 500" onClick={onBlowCandle} xmlns="http://www.w3.org/2000/svg">
            ...
            <p style={{ fontSize: '1.2rem', marginTop: '10px' }}>Click on cake for more 🎂</p>
        </div>
    );
}
